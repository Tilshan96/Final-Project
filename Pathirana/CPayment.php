      ...
      <section class="hero-section">
        <div class="section-content">
          <div class="hero-details">
            ...
            <p class="description">You can Confirm and Manage your Payments in here.....</p>
            <div class="buttons">
              <a href="PayConfirm.php" class="button order-now">Confirm</a>
              <a href="CPaymentManage.php" class="button contact-us">Manage</a>
            </div>
          </div>
          <div class="hero-image-wrapper">
            <img src="paymentconfirm.jpg" alt="img" class="hero-image" />
          </div>
        </div>
      </section>
