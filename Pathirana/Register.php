      ...
      <section class="hero-section">
        <div class="section-content">
          <div class="hero-details">
            ...
            <p class="description">You can Add or Manage Customer Information in here.....</p>
            <div class="buttons">
              <a href="CRegfrm.php" class="button order-now">Add</a>
              <a href="CRegmanage.php" class="button contact-us">Manage</a>
            </div>
          </div>
          <div class="hero-image-wrapper">
            <img src="register.jpeg" alt="img" class="hero-image" />
          </div>
        </div>
      </section>
